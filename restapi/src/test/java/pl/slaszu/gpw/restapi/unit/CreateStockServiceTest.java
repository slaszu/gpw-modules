package pl.slaszu.gpw.restapi.unit;

import org.junit.jupiter.api.BeforeEach;
import org.junit.jupiter.api.Test;
import pl.slaszu.gpw.restapi.sharedkernel.domain.EventDispatcherInterface;
import pl.slaszu.gpw.restapi.stock.application.CreateStock.CreateStockCommand;
import pl.slaszu.gpw.restapi.stock.application.CreateStock.CreateStockService;
import pl.slaszu.gpw.restapi.stock.domain.model.Stock;
import pl.slaszu.gpw.restapi.stock.domain.repository.StockPriceRepositoryInterface;
import pl.slaszu.gpw.restapi.stock.domain.repository.StockRepositoryInterface;
